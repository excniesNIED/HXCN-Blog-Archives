...
![1](https://gastigado.cnies.org/d/halo20250323dual_boot/14.png)

在设备加密栏位，设置为“关闭”。

![2](https://gastigado.cnies.org/d/halo20250323dual_boot/2.png)

系统会提醒您是否需要关闭设备加密，点选“关闭”即可关闭设备加密。

![3](https://gastigado.cnies.org/d/halo20250323dual_boot/3.png)

### 2. 关闭 Bitlocker

打开“控制面板”，选择系统和安全 -> Bitlocker 驱动器加密

![4](https://gastigado.cnies.org/d/halo20250323dual_boot/4.png)
...
![5](https://gastigado.cnies.org/d/halo20250323dual_boot/5.png)

取消选择“启用快速启动”和“休眠”

![5](https://gastigado.cnies.org/d/halo20250323dual_boot/6.png)
...
![5](https://gastigado.cnies.org/d/halo20250323dual_boot/7.png)
...
![5](https://gastigado.cnies.org/d/halo20250323dual_boot/8.png)

选择想要制作镜像的 U 盘，点击安装。

安装完成后，将 Ubuntu 24.04 镜像复制到 Ventoy 分区，并使用 [HashMyFiles](https://ed.qcea.top/ChaIndex/Softwares/Windows/Hash) 等工具校验。

![5](https://gastigado.cnies.org/d/halo20250323dual_boot/9.png)
...
![5](https://gastigado.cnies.org/d/halo20250323dual_boot/10.png)
...
![12](https://gastigado.cnies.org/d/halo20250323dual_boot/12.jpg) 

![11](https://gastigado.cnies.org/d/halo20250323dual_boot/11.png)

### 高级重启

如果你的电脑不方便进入 BIOS，可以在 Windows 下，按住 Shift 键点击重启 -> 使用设备 -> 选择启动盘即可.

![11](https://gastigado.cnies.org/d/halo20250323dual_boot/13.png)

## Ubuntu 安装

进入 Ubuntu 镜像，选择 `Try or Install Ubuntu` 。

![install (0)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(0).png)

进入安装界面，在此可以切换中文：

![install (1)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(1).png)

无障碍设置，可以直接跳过，如果有使用需求可以进行设置：

![install (2)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(2).png)

键盘布局默认选择汉语，可以直接下一步

![install (3)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(3).png)

连接有线或无线网络

![install (4)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(4).png)

如果提示安装程序有可用更新可以跳过

![install (5)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(5).png)

选择“安装 Ubuntu”

![install (6)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(6).png)

选择“交互安装”

![install (7)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(7).png)

选择“默认集合”，如果有需要可以选择“扩展集合”

![install (8)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(8).png)

推荐全部勾选，可以自动安装一些必要软件和驱动

![install (9)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(9).png)

如果只需要简单安装 Windows 和 Ubuntu 双系统，选择“在 Windows Boot Manager 中安装 Ubuntu”

![install (10)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(10).png)

根据需求调整 Ubuntu 分区大小，建议 64G 以上。如果需要在 Ubuntu 完成较为重度的工作，建议留出 128 GB 或者 256 GB 的磁盘空间。

![install (10.5)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(10.5).png)
...
![install (13)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(13).png)

点击“安装”正式开始安装

![install (14)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(14).png)
...
![install (15.2)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(15.2).png)

![install (15)](https://gastigado.cnies.org/d/halo20250323dual_boot/install%20(15.5).png)

## 如何切换 Windows 和 Ubuntu

Ubuntu 安装后的首次重启可以选择启动 Windows 还是 Ubuntu，默认为 Ubuntu。

![01](https://gastigado.cnies.org/d/halo20250323dual_boot/18.png)

如果日常使用 Windows，可以通过设置 BIOS 引导顺序默认启动 Windows。

![02](https://gastigado.cnies.org/d/halo20250323dual_boot/15.jpg)

同理，要使用 Ubuntu 时，将 Ubuntu 切换至第一个即可。

![03](https://gastigado.cnies.org/d/halo20250323dual_boot/16.jpg)

安装完成重启到 Windows，发现时间慢了 12 小时，右键右下角时钟 -> 调整日期和时间 -> 立即同步 即可。

![36.调整时间](https://gastigado.cnies.org/d/halo20250323dual_boot/17.png)
